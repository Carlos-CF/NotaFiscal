...
@RestController
@RequestMapping(value = "/frequenciaConta")
public class FrequenciaContaController {
    
    @Autowired
    private FrequenciaContaService frequenciaContaService;
    
    @PostMapping
    @ApiResponses({
        @ApiResponse(responseCode = "201", description = "Criado (Created)", content = {
            @Content(mediaType = "application/json", schema = @Schema(implementation = FrequenciaContaDTO.class))}),
    ...
    public ResponseEntity<Object> cadastrar(@RequestBody FrequenciaContaDTO objeto) throws Exception {
        return frequenciaContaService.cadastrar(objeto);
    }
    ...
    public ResponseEntity<Object> listar() throws Exception {
        return frequenciaContaService.listar();
    }
    ...
    public ResponseEntity<Object> listarPorId(@PathVariable Long idObjeto) throws Exception {
        return frequenciaContaService.listarPorId(idObjeto);
    }
    ...
    public ResponseEntity<Object> editar(@PathVariable Long idObjeto, @RequestBody FrequenciaContaDTO objeto) throws Exception {
        return frequenciaContaService.editar(idObjeto, objeto);
    }
    ...
    public ResponseEntity<Object> excluir(@PathVariable Long idObjeto) throws Exception {
        return frequenciaContaService.excluir(idObjeto);
    }
    ...
    public ResponseEntity<Object> mudarStatus(@PathVariable Long idObjeto) throws Exception {
        return frequenciaContaService.mudarStatus(idObjeto);
    }
}
