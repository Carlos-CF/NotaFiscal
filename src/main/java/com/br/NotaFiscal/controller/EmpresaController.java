...
public class EmpresaController {
    ...
    public ResponseEntity<Object> cadastrar(@RequestBody EmpresaDTO objeto) throws Exception {
        return empresaService.cadastrar(objeto);
    }
    ...
    public ResponseEntity<Object> listarPorId(@PathVariable Long idObjeto) throws Exception {
        return empresaService.listarPorId(idObjeto);
    }
    ...
    public ResponseEntity<Object> editar(@PathVariable Long idObjeto, @RequestBody EmpresaDTO objeto) throws Exception {
        return empresaService.editar(idObjeto, objeto);
    }
    ...
    public ResponseEntity<Object> excluir(@PathVariable Long idObjeto) throws Exception {
        return empresaService.excluir(idObjeto);
    }
    ...
    public ResponseEntity<Object> mudarStatus(@PathVariable Long idObjeto) throws Exception {
        return empresaService.mudarStatus(idObjeto);
    }
